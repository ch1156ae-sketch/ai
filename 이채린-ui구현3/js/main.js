...
// 아래 한 줄만 본인의 Apps Script 웹앱 URL(/exec로 끝나는 주소)로 바꾸면 됩니다.
...
quickBookingForm.addEventListener("submit", async (event) => {
    ...
    if (GOOGLE_APP_SCRIPT_URL === "여기에_배포한_웹앱_URL을_넣어주세요") {
        alert(
            "Apps Script 웹앱 URL을 main.js의 GOOGLE_APP_SCRIPT_URL에 먼저 넣어주세요.",
        );
        return;
    }
